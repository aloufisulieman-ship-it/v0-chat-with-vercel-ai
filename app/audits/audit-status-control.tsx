...
// تغيير حالة التدقيق من نافذة التفاصيل. يظهر كقائمة منسدلة لمدير النظام، والمدقق،
// ومدير السلامة والصحة المهنية تحديداً (manager + قسم HSE معاً، لا الدور وحده)؛
// وغيرهم — بمن فيهم مفتش السلامة الميداني — يرى الحالة وأثر آخر تغيير للقراءة.
// القيد مفروض على الخادم في updateAuditStatus أيضاً (canChangeAuditStatus)،
// فالإخفاء هنا للتجربة لا للحماية.
