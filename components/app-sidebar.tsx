...
const nav: { href: string; labelKey: string; icon: typeof LayoutDashboard; module: ModuleKey }[] = [
  ...
  { href: "/context", labelKey: "modules.context", icon: Building2, module: "context" },
  { href: "/policy", labelKey: "modules.policy", icon: BookMarked, module: "policy" },
  { href: "/objectives", labelKey: "modules.objectives", icon: Target, module: "objectives" },
  { href: "/legal-register", labelKey: "modules.legal-register", icon: Scale, module: "legal-register" },
  { href: "/consultation", labelKey: "modules.consultation", icon: MessagesSquare, module: "consultation" },
  { href: "/emergency", labelKey: "modules.emergency", icon: Siren, module: "emergency" },
  { href: "/contractors", labelKey: "modules.contractors", icon: HardHat, module: "contractors" },
  { href: "/management-review", labelKey: "modules.management-review", icon: Gavel, module: "management-review" },
  { href: "/internal-audit", labelKey: "modules.internal-audit", icon: FileCheck, module: "internal-audit" },
